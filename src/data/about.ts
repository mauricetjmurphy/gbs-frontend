export const aboutContent = {
  ...
  para2: `Our team of expert writers, editors, and researchers use GPT-3 to
  ...
  para3: `We understand that everyone has different interests and that's why
  ...
  para4: ` Our site is updated daily with new content, so be sure to check
  ...
  para5: `Thank you for visiting InTheKnow. We hope you enjoy reading our
