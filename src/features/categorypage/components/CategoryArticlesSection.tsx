...
const CategoryArticlesContainer = styled(Grid)(({ theme }) => ({
  background: "#fff",
...
const CategoryArticlesSection: React.FC<CategoryArticlesProps> = (props) => {
  return (
    <CategoryArticlesContainer container>
