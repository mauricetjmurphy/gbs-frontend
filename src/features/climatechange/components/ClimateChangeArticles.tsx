...
const ClimateChangeArticlesContainer = styled(Grid)(({ theme }) => ({
  background: "#fff",
...
const ClimateChangeArticles: React.FC<ClimateChangeArticlesProps> = (props) => {
  return (
    <ClimateChangeArticlesContainer container>
...
export default ClimateChangeArticles;
